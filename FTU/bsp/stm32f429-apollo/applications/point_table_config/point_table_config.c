...
//   使能          面板开入号	                点号                                      上次PIN   取反   计时器
    { 1,       INDEX_SWITCH_OPEN_DI,          &g_TelesignalAddr.switchOpen,                   0,      0,      0},
    { 1,       INDEX_SWITCH_CLOSE_DI,         &g_TelesignalAddr.switchClose,                  0,      0,      0},
    { 1,       INDEX_ENERGY_STORAGE_DI,       &g_TelesignalAddr.operatingMechanism,           0,      1,      0},
    { 1,       INDEX_LOW_PRESSURE_DI,         &g_TelesignalAddr.lowPressure,                  0,      0,      0},
    { 1,       INDEX_POWER_FAILURE_ALARM_DI,  &g_TelesignalAddr.powerFaultAlarm,              0,      0,      0},
    { 1,       INDEX_BETTERY_UNDERVOLTAGE_DI, &g_TelesignalAddr.batteryUnderVoltageAlarm,     0,      0,      0},
    { 1,       INDEX_BATTERYA_CTIVATE_DI,     &g_TelesignalAddr.batteryActivationStatus,      0,      0,      0},
    { 1,       INDEX_BATTERY_LOSS_ALARM_DI,   &g_TelesignalAddr.batteryLossAlarm,             0,      1,      0},
};
...
//   使能    名称	        点号                                         遥信      属性  故障记录使能    描述
    ...
    { 1,  "电源故障告警", &g_TelesignalAddr.powerFaultAlarm,             NULL,     0xff,    	1,		{"无", "告警"},    		{"告警->复位","无->告警"}},
    { 1,  "电池欠压告警", &g_TelesignalAddr.batteryUnderVoltageAlarm,    NULL,     0xff,    	1,		{"无", "告警"},    		{"告警->复位","无->告警"}},
    { 1,  "电池活化状态", &g_TelesignalAddr.batteryActivationStatus,     NULL,     0xff,    	1,		{"无", "活化"},    		{"活化->结束","开始活化"}},
    { 1,  "交流失电告警", &g_TelesignalAddr.batteryLossAlarm,            NULL,     0xff,    	1,		{"无", "告警"},    		{"告警->复位","无->告警"}},
