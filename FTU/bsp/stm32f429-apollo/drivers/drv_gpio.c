...
struct rt_device_pin_mode pin_mode[] = 
{
    ...
    {LOGIC_OPEN_DO, PIN_MODE_OUTPUT},
    {LOGIC_CLOSE_DO, PIN_MODE_OUTPUT},
    ...
    /* DI */
    {SWITCH_OPEN_DI, PIN_MODE_INPUT_PULLUP},
    {SWITCH_CLOSE_DI, PIN_MODE_INPUT_PULLUP},
    {ENERGY_STORAGE_DI, PIN_MODE_INPUT_PULLUP},
    {LOW_PRESSURE_DI, PIN_MODE_INPUT_PULLUP},
    {BATTERY_LOSS_ALARM_DI, PIN_MODE_INPUT_PULLUP},
    {BATTERYA_CTIVATE_DI, PIN_MODE_INPUT_PULLUP},
    {BETTERY_UNDERVOLTAGE_DI, PIN_MODE_INPUT_PULLUP},
    {POWER_FAILURE_ALARM_DI, PIN_MODE_INPUT_PULLUP},
    {MCU_POWER_ALARM_DI, PIN_MODE_INPUT_PULLUP},
    
    {HANDHELD_OPEN_PRESET, PIN_MODE_INPUT_PULLDOWN},
    {HANDHELD_OPEN_EXECUTE, PIN_MODE_INPUT_PULLDOWN},
    {HANDHELD_CLOSE_PRESET, PIN_MODE_INPUT_PULLDOWN},
    {HANDHELD_CLOSE_EXECUTE, PIN_MODE_INPUT_PULLDOWN},
...
struct rt_device_pin_status pin_status[] = 
{
    ...
    {LOGIC_OPEN_DO, GPIO_PIN_SET},
    {LOGIC_CLOSE_DO, GPIO_PIN_SET},
    {ACTIVATE_START_DO, GPIO_PIN_SET},
    {ACTIVATE_STOP_DO, GPIO_PIN_SET},
    {BETTERY_DROP_OUT_DO, GPIO_PIN_SET},
    {BACKEUP_DO, GPIO_PIN_SET},
    /* DI */
    {SWITCH_OPEN_DI, GPIO_PIN_SET},
    {SWITCH_CLOSE_DI, GPIO_PIN_SET},   
    {ENERGY_STORAGE_DI, GPIO_PIN_SET},
    {LOW_PRESSURE_DI, GPIO_PIN_SET},
    {POWER_FAILURE_ALARM_DI, GPIO_PIN_SET},    
    {BETTERY_UNDERVOLTAGE_DI, GPIO_PIN_SET},
    {BATTERYA_CTIVATE_DI, GPIO_PIN_SET},    
    {BATTERY_LOSS_ALARM_DI, GPIO_PIN_SET},
    {MCU_POWER_ALARM_DI, GPIO_PIN_SET},
    
    {HANDHELD_OPEN_PRESET, GPIO_PIN_RESET},
    {HANDHELD_OPEN_EXECUTE, GPIO_PIN_RESET},
    {HANDHELD_CLOSE_PRESET, GPIO_PIN_RESET},
    {HANDHELD_CLOSE_EXECUTE, GPIO_PIN_RESET},
