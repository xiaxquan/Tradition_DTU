...
#define LOGIC_OPEN_DO             118
#define LOGIC_CLOSE_DO            45
#define BACKEUP_DO1               122   // 不知道定义成啥   因为不知道是干啥的
#define BACKEUP_DO2               128
#define BACKEUP_DO3               117
